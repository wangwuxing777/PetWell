...
struct ClinicSelectionView: View {
    ...
    var filteredClinics: [Clinic] {
        ...
        if !searchText.isEmpty {
            result = result.filter { $0.name.localizedCaseInsensitiveContains(searchText) || $0.address.localizedCaseInsensitiveContains(searchText) }
        }
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: 12) {
                    ...
                    Menu {
                        ...
                        .padding(.vertical, 8)
                        .background(selectedRegion == .all ? Color(UIColor.secondarySystemBackground) : Color.blue.opacity(0.1))
                    ...
                    Button(action: { sortOption = .rating }) {
                        Text("Rating")
                            ...
                            .padding(.vertical, 8)
                            .background(sortOption == .rating ? Color.orange.opacity(0.1) : Color(UIColor.secondarySystemBackground))
                    ...
                    Button(action: { sortOption = .distance }) {
                        Text("Distance")
                            ...
                            .padding(.horizontal, 16)
                            .padding(.vertical, 8)
                            .background(sortOption == .distance ? Color.blue.opacity(0.1) : Color(UIColor.secondarySystemBackground))
